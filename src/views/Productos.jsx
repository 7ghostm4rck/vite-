...
import CuadroBusquedas from "../components/busquedas/cuadrobusqueadas";
...
const Productos = () => {
  ...
  // Estado para manejar el modal de registro y los datos del nuevo producto
  ...
  const [nuevoProducto, setNuevoProducto] = useState({
    ...
    stock: null,
    categoria: "",
    imagen: "", // Campo para la imagen en base64
  });
